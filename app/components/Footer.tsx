    ...
    <footer className="bg-[#3a3d3a] border-t border-gray-500/40 py-12 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <nav className="flex flex-wrap justify-center gap-6">
          <Link href="/#about"      className="text-sm text-white hover:text-gray-200 transition-colors">About</Link>
          <Link href="/#faqs"       className="text-sm text-white hover:text-gray-200 transition-colors">FAQs</Link>
          <Link href="/#contact"    className="text-sm text-white hover:text-gray-200 transition-colors">Contact</Link>
          <Link href="/disclaimer"  className="text-sm text-white hover:text-gray-200 transition-colors">Disclaimer</Link>
        </nav>
