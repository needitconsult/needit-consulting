    ...
    <section id="about" className="relative py-24 px-6">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <motion.div {...fadeUp(0.28)} className="bg-white rounded-2xl border border-gray-200 p-8 mb-6">
          ...
          <p className="text-right mt-5 text-green-700" style={{ fontFamily: "'Dancing Script', cursive", fontSize: "2rem", lineHeight: 1.2 }}>
            — Ashley Ann
          </p>
        </motion.div>
        ...
        <motion.div {...fadeUp(0.3)} className="bg-green-600 rounded-2xl p-8 text-center">
          <h3 className="text-xl font-medium text-white mb-2">Ready to work with me and get your business on track for more?</h3>
          <p className="text-white/75 text-sm mb-6 leading-relaxed">Free 30-minute consultation. No sales pitch — just a straight conversation about what you need and whether NeedIT is the right fit.</p>
