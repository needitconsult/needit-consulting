      ...
      {visible && !dismissed && (
        ...
        >
          <motion.div
            ...
            className="relative w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl bg-white overflow-hidden"
            style={{ boxShadow: "0 -8px 40px rgba(0,0,0,0.22), 0 0 0 1px rgba(22,163,74,0.15)", cursor: "auto" }}
            onClick={(e) => e.stopPropagation()}
          >
            {/* Green header */}
            <div className="px-6 pt-6 pb-5" style={{ background: "linear-gradient(135deg, #15803d 0%, #16a34a 100%)" }}>
              <button
                onClick={dismiss}
                className="absolute top-4 right-4 w-11 h-11 rounded-full flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-colors"
                aria-label="Close"
                type="button"
              >
                <X className="w-5 h-5" />
              ...
              <h2 className="text-white text-lg font-extrabold leading-snug pr-8">
                Get the Free VoIP Setup Checklist
              </h2>
              <p className="text-white/80 text-sm mt-1.5 leading-relaxed pr-4">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input type="text" id="First_Name" name="First Name" required maxLength={40} placeholder="Jane"
                      className="w-full px-3 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-gray-900 text-sm placeholder-gray-400 outline-none focus:border-green-500 transition-colors" />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">
                      Last Name <span className="text-red-500">*</span>
                    </label>
                    <input type="text" id="Last_Name" name="Last Name" required maxLength={80} placeholder="Smith"
                      className="w-full px-3 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-gray-900 text-sm placeholder-gray-400 outline-none focus:border-green-500 transition-colors" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input type="email" id="Email" name="Email" required maxLength={100} placeholder="jane@yourbusiness.com"
                    className="w-full px-3 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-gray-900 text-sm placeholder-gray-400 outline-none focus:border-green-500 transition-colors" />
                </div>

                <button
                  type="submit"
                  className="w-full py-3 rounded-xl bg-green-600 hover:bg-green-500 text-white font-extrabold text-sm transition-all active:scale-[0.99] mt-1"
